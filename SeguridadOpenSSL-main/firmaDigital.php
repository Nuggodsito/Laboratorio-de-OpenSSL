<?PHP
 ...
 $privateKey = openssl_pkey_new(array(
	    "config" => "C:\OpenSSL-Win64\bin\openssl.cnf", // Ruta al archivo de configuración de OpenSSL	
    ...
    openssl_pkey_export_to_file($privateKey, 'private.key' ,null,["config" => 'C:/OpenSSL-Win64/bin/cnf/openssl.cnf']);
